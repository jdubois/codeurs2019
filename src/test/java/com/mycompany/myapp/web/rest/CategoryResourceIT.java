...
public class CategoryResourceIT {
    ...
    private static final String DEFAULT_CODEURS_2019 = "AAAAAAAAAA";
    private static final String UPDATED_CODEURS_2019 = "BBBBBBBBBB";
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category()
            .codeurs2019(DEFAULT_CODEURS_2019)
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category()
            .codeurs2019(UPDATED_CODEURS_2019)
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getCodeurs2019()).isEqualTo(DEFAULT_CODEURS_2019);
    ...
    @Test
    @Transactional
    public void checkCodeurs2019IsRequired() throws Exception {
        int databaseSizeBeforeTest = categoryRepository.findAll().size();
        // set the field null
        category.setCodeurs2019(null);
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].codeurs2019").value(hasItem(DEFAULT_CODEURS_2019)))
    ...
    public void getCategory() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories/{id}", category.getId()))
            ...
            .andExpect(jsonPath("$.codeurs2019").value(DEFAULT_CODEURS_2019))
    ...
    public void updateCategory() throws Exception {
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.getCodeurs2019()).isEqualTo(UPDATED_CODEURS_2019);
