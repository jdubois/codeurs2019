...
describe('Category e2e test', () => {
  ...
  it('should create and save Categories', async () => {
    ...
    await categoryComponentsPage.clickOnCreateButton();
    await promise.all([
      categoryUpdatePage.setCodeurs2019Input('codeurs2019'),
    ...
    expect(await categoryUpdatePage.getCodeurs2019Input()).to.eq('codeurs2019', 'Expected Codeurs2019 value to be equals to codeurs2019');
