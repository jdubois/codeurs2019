...
export class CategoryUpdatePage {
  ...
  codeurs2019Input = element(by.id('field_codeurs2019'));
  ...
  async setCodeurs2019Input(codeurs2019) {
    await this.codeurs2019Input.sendKeys(codeurs2019);
  }

  async getCodeurs2019Input() {
    return await this.codeurs2019Input.getAttribute('value');
  }
